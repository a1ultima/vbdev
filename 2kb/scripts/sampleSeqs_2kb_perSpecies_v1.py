...
# Sample up/down steam seqs from scanned genes
#______________________________________________#
def sampleSequences (sample_direction, sample_range, ensembl_genome, sample_data={}, sample_seqs={}):
    """ Example Args:
    ...
    genes = ensembl_genome.getGenesMatching(BioType='protein_coding')

    geneIds = [gene.StableId for gene in genes]
