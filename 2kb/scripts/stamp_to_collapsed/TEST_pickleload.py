...
S_vec = np.arange(1,21,1)

H_vec = np.arange(3,30,1)

S_and_H_vector = list(product(S_vec,H_vec))
...
# blacklist, summary, clade_groups, cluster_to_stats = blacklist_then_summaryStats_from_shell( e = 0.05, species_threshold = 3.0, entropy_threshold = 5.0, cluster_to_stats=cluster_to_stats )
