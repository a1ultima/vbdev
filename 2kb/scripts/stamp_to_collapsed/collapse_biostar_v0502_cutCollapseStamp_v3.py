...
save_d  = 0.05
cool    = exploreCutoffs( '../data/stamp_data/out/dreme_100bp_e0.05/SWU_SSD/', 'e005.tree', d_from = 0., d_to = .1, d_step = 0.05,  save_d = save_d)
...
dataPath_dremeAllSp = '../../data/stamp_data/in/dreme_100bp_e0.05/'          # clustered motif fastas, given d
...
dataPath_clusters_in    = '../../data/stamp_data/out/dreme_100bp_e0.05/SWU_SSD/cluster_motifs_d'+str(save_d)+'/headers_for_fasta/'
dataPath_clusters_out   = '../../data/stamp_data/out/dreme_100bp_e0.05/SWU_SSD/cluster_motifs_d'+str(save_d)+'/fasta/'
...
# path args
dataPath_i_fasta        = '../../data/stamp_data/out/dreme_100bp_e0.05/SWU_SSD/cluster_motifs_d'+str(save_d)+'/fasta/'
dataPath_i_common       = '../../data/stamp_data/in/common/'
dataPath_o              = '../../data/stamp_data/out/dreme_100bp_e0.05/SWU_SSD/cluster_motifs_d'+str(save_d)+'/family_binding_matrices/'
