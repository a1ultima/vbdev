...
def sampleSequences ( ensembl_genome, sample_direction='upstream', sample_range=2000, sample_data={}, sample_seqs={}):
    ...
    for geneId in geneIds:
        ...
        if sample_direction == 'upstream':
            ...
            sampleLocation  = geneLocation.resized(-sample_range,-len(geneLocation)) #TODO: check if off by 1 -> tested
            #                                       ^            ^ WARN: direction specific
            ...
            if not overlap_features:            # keep full sample & skip to next loop if no features are found
                ...
                # TRUNCATION STEP 1:    remove exons that are so far down/upstream of sample they are beyond sample overlap
                #
                ...
                if sample_direction=='upstream':
                    ...
                    overlap_limit = overlap_locations[0]  # the last overlapping feature beyond which there are no overlaps w/i sample
