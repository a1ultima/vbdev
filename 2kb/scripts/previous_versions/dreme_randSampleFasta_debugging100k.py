...
def allSpecies(speciesFile, dataPath_in, dataPath_out, n_seqs = 10000, len_seq = 100):
    """
    Notes: 
    ...
    def rand_parts(seq, n, l):
        ...
        try:
            ...
            pickle.dump(meta_index,open('testData.p','wb'))
...
if __name__ == "__main__":
    ...
    try: 
        ...
        len_seq = 100
    allSpecies( speciesFile, dataPath_in, dataPath_out, n_seqs, len_seq )
    print('COMPLETE!')