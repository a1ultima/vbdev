...
def sampleAllSpecies(species_list,sample_directions):
    ...
    for sample_direction in sample_directions:
        for species in species_list:
            ...
            samples_read        = sampleSequences_read (    genome, sample_direction=sample_direction, sample_range=2000, take_annotated_utr=False, sample_data={}, sample_seqs={}, test_it=False)
...
samples_read    = sampleSequences_read (    genome, sample_direction='upstream', sample_range=2000, take_annotated_utr=False, sample_data={}, sample_seqs={}, test_it=True)
samples_write   = sampleSequences_write(    genome, samples_read, fasta_it=True, pickle_it=True, include_genes=False)
